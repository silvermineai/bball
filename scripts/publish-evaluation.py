"""Build the historical weekly experiment, validate, archive and deploy."""
...
run([sys.executable, "-m", "ncaa_scraper.basketball_evaluation"])
...
run([sys.executable, "scripts/archive-evaluation.py"])
