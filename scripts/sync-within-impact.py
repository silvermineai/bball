"""Archive NCAA within-team RAPM source releases and receipts in R2."""
...
for season in range(2010, 2027):
    ...
    print(f"Archived within-team RAPM {season}", flush=True)
