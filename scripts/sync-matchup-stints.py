"""Archive NCAA matchup-stint parquet releases and receipts in R2."""
...
for season in range(2019, 2027):
    ...
    print(f"Archived matchup stints {season}", flush=True)
