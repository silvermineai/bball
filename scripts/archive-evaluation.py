"""Archive a verified basketball experiment and its implementation in private R2."""
...
LOCAL = ROOT / ".local/evaluation-research"
LOCAL.mkdir(parents=True, exist_ok=True)
lock = (ROOT / ".local/basketball-evaluation.lock").open("w")
try:
...
key = f"bball-research/basketball/experiments/{sha}.tar"
