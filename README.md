...
Existing basketball URLs such as `/scout/333` redirect to the native `/basketball/scout/333/` dossier aliases. Native pages replace the old desk, player index, recruiting landing page and scouting archive index; game-planning and other remaining archive tools use the preserved application.
