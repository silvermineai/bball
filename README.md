...
| NCAA player box archive | `/basketball/ncaa-player-box/` | Browse 2016–17 through 2025–26 NCAA-derived game-level rows plus historical 2010–16 player-season summaries with shooting splits, playmaking context and a season-scoped integrity audit in the separate NCAA ID namespace |
