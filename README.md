...
| NCAA player box archive | `/basketball/ncaa-player-box/` | Browse 2022–23 through 2025–26 NCAA-derived game-level rows plus historical 2010–22 player-season summaries with shooting splits and playmaking context in the separate NCAA ID namespace |
