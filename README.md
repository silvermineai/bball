...
| NCAA career leaderboard | `/basketball/ncaa-careers/` | Aggregate NCAA player-season rows across a selectable window, rank career production and show every observed program |
