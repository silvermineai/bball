...
| NCAA player cards | `/basketball/ncaa-player/` | Open one source-native NCAA ID across season production, shot profile, roster/high-school context, RAPM and recent game evidence |
