...
def export_ncaa_player_box_sql(conn, path, seasons=(2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026)):
    """Export eight recent NCAA game-row seasons; older seasons use summaries."""
