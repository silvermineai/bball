...
class EspnPickcenterTests(unittest.TestCase):
    ...
    def test_bounded_capture_receipt_reports_unrequested_candidates(self):
        ...
        self.assertEqual(receipt["candidate_confirmed_start_games"], 3)
        self.assertEqual(receipt["selected_confirmed_start_games"], 2)
        self.assertEqual(receipt["selected_unconfirmed_start_games"], 0)
