...
from ncaa_scraper.mens_lower_schedule import (
    contest_query_url,
    parse_contests,
...
def test_query_contract_carries_exact_mens_division():
...
def test_calendar_and_contests_preserve_explicit_division():
    ...
    assert calendar == [{"sport": "basketball", "gender": "men", "division": 2, "contest_date": "03/04/2026", "count": 1}]
...
def test_scope_or_identity_fail_closed():
    ...
    try:
        ...
        assert "outside men's basketball" in str(exc)
    else:
