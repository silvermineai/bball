...
- The [NCAA roster intel](/basketball/ncaa-rosters/) archive adds 92,220 attributed team-roster rows from 2010–11 through 2025–26 with NCAA player IDs, class, position, height, hometown and high-school context. These records support recruiting research but do not assert commitment, transfer or eligibility status.
