...
export const metadata = {
  ...
  description: "Search identified college football player records across 17 the retained archive source seasons, with category-specific EPA, workload and team history.",
