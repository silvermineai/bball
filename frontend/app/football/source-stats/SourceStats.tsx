...
type Result = { dataset: Dataset; season: number; page: number; page_size: number; total: number; rows: Row[] };
  ...
  return (
    <>
      ...
      <div className="toolbar">
        ...
        <label className="control"><span>PLAYER, TEAM OR SOURCE FIELD</span><input type="search" maxLength={100} value={query} placeholder="Search literal source text" onChange={(event) => { setQuery(event.target.value); setPage(0); }} /></label>
