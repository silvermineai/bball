  ...
  return (
    <p className="note" role="status">
      {status === "live" && archive
        ...
        : status === "fallback"
          ? <>The live NCAA player archive is temporarily unavailable; the published player release remains available. <Link href="/basketball/ncaa-player-box/">Open the player archive →</Link></>
