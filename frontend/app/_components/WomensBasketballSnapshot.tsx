...
type Forecast = { game_id: string; date?: string; home?: string; away?: string; prediction: { home_win_probability: number; predicted_margin: number; predicted_home_score: number; predicted_away_score: number; estimate_type: string } };
type Edition = {
  season: number;
  ...
  limitations: string[];
  forecast?: { model_id: string; validation: { games: number; margin_mae: number; win_accuracy: number; brier_score: number; log_loss?: number }; calibration?: { games?: number }; forecasts: Forecast[] };
};
