...
import { formatMarketComparisonReadiness, marketCaptureCoverageDetail, marketCaptureDiagnostic, marketCaptureHistoryDiagnostic, modelScopedScorecardPath } from "../_lib/market-readiness";
...
export default function LiveBasketballMarketStatus() {
  ...
  const captureCoverage = marketCaptureCoverageDetail(archive);
  ...
  const readinessDiagnostic = formatMarketComparisonReadiness(scorecard?.sports?.basketball?.comparison_readiness);
