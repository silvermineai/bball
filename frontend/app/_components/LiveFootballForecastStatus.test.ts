...
describe("football forecast coverage status", () => {
  ...
  it("formats held-out model evidence without turning missing metrics into claims", () => {
    expect(formatFootballModelEvidence({
      training_games: 3331,
      evaluation: { games: 784, winner_accuracy: 0.6543, margin_mae: 14.24, baseline_margin_mae: 15.99, brier: 0.211, interval_coverage: 0.806 },
      calibration: { games: 787, margin_half_width: 23.7 },
    })).toBe("held out 784 games · 65.4% winner accuracy · 14.2 pt margin MAE · 1.8 pts lower than the baseline · Brier 0.211 · 80.6% range coverage · calibrated on 787 games");
