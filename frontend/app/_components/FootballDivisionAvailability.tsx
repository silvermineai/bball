...
export default function FootballDivisionAvailability({ division }: { division: LowerFootballDivision }) {
  ...
  return (
    <section className="paper-panel football-division-availability" aria-labelledby="football-division-availability-title">
      ...
      <h2 id="football-division-availability-title">D{availability.division} schedule and results are available</h2>
      <p>
        The retained football edition includes upcoming Division {availability.division} schedule rows and a completed-score archive. Player stats, team production, rankings and Silvermine predictions for this division are not published yet; blank fields stay blank until division-labeled records pass validation.
      </p>
