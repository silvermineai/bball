...
type BoxEdition = {
  season: number;
  generated_at: string;
  coverage: { players: number; rows: number; games: number; played_rows: number; dnp_rows: number; teams: number };
  players: BoxPlayer[];
};
