...
export default function Page() {
  ...
  const supplemental = [
    ...
    },
    {
      ...
      note: "Retained NCAA source rows across every available 2010–26 season; the public D1 serves the two recent game releases plus historical season summaries. The source-release link opens the latest exact Parquet edition.",
    },
    {
      key: "pbp",
