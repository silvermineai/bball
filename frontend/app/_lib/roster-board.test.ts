  ...
  players: [
    {
      ...
      prior_production: { games: 30, minutes: 900, mpg: 30, ppg: 14, rpg: 4, apg: 3, spg: 1, bpg: 0, topg: 2, efg: .55, ts: .58, three_pct: .35, ft_rate: .2, three_rate: .4, tov_rate: .12, teams: ["Old U"] },
    },
    {
      ...
      prior_production: { games: 28, minutes: 560, mpg: 20, ppg: 10, rpg: 6, apg: 2, spg: 1, bpg: 1, topg: 1, efg: .6, ts: .62, three_pct: .4, ft_rate: .3, three_rate: .3, tov_rate: .1, teams: ["Test U"] },
    },
    {
