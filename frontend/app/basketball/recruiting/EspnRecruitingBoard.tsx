...
export default function EspnRecruitingBoard() {
  ...
  useEffect(() => {
    ...
    if (requestedSeason === "2026" || requestedSeason === "2027" || requestedSeason === "2028" || requestedSeason === "2029") setSeason(requestedSeason);
  ...
  useEffect(() => {
    const controller = new AbortController();
    Promise.allSettled(["2026", "2027", "2028", "2029"].map(async (classYear) => {
  ...
  return (
    <section className="section">
      ...
      <div className="toolbar">
        <label className="control"><span>CLASS</span><select value={season} onChange={(event) => { setSeason(event.target.value); setPage(0); }}><option value="2026">2026</option><option value="2027">2027</option><option value="2028">2028</option><option value="2029">2029</option></select></label>
