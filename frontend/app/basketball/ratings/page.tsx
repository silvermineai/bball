  ...
  return (
    <>
      <div className="page-title">
        ...
        <p>
          Independent opponent-adjusted offense, defense, tempo and four-factor
          rates. Ratings use a minimum of ten observed training-season games per
          program. Historical performance is a baseline for 2026–27, not a
          roster-adjusted preseason ranking.
        </p>
      </div>
      <Ratings rows={getBasketball().ratings} />
      <p className="note">
        Adj O and Adj D: points per 100 estimated possessions. Lower Adj D and
        turnover rate are better. The adjusted factor columns use the same
