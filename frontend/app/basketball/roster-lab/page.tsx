  ...
  return (
    <>
      <div className="page-title">
        ...
        <p>
          A program-by-program view of the source-listed roster, prior recorded minutes, source-reported roster shape, publisher Box BPM context, independent efficiency rating and published schedule coverage. Use it to prepare questions for a matchup and to find recruiting context worth checking.
        </p>
      ...
      <section className="section paper-panel">
        ...
        <p className="note">These are descriptive roster observations. They do not enter the Silvermine forecast, establish transfer status or eligibility, or imply that an unlisted player left. The publisher BPM fields are source-attributed prior value where exact athlete/team rows are available; missing values stay blank. The independent rating is historical opponent-adjusted efficiency from the model notebook.</p>
      </section>
