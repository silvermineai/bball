...
const metrics = [
  ...
  },
  {
    ...
    value: "Recorded offensive rebounds divided by games played in the historical player archive.",
    use: "Use it to separate second-chance creation from total rebounding. Check minutes, team context and the source field coverage before comparing roles.",
  },
  {
    name: "Defensive rebounds per game",
    value: "Recorded defensive rebounds divided by games played in the historical player archive.",
    use: "Use it to describe a player’s defensive glass contribution, then read it with team defensive-rebound context and workload.",
  },
  {
  ...
  },
  {
    ...
    value: "Recorded steals divided by games played in the player-box archive.",
    use: "Use it to describe defensive event production alongside minutes, opponent context and blocks. It is not a complete measure of on-ball defense or a future projection.",
  },
  {
    name: "Blocks per game",
    value: "Recorded blocks divided by games played in the player-box archive.",
    use: "Use it to describe rim-protection events alongside minutes, fouls and defensive role. It does not measure all defensive possessions or establish a future matchup result.",
  },
  {
...
const metricTopics: Record<string, LearningTopic> = {
  ...
  "Offensive rebounds per game": "player",
  "Defensive rebounds per game": "player",
  "Minutes per game": "player",
  "Turnovers per game": "player",
  "Steals per game": "player",
  "Blocks per game": "player",
...
const metricLinks: Record<string, string> = {
  ...
  "Effective field-goal percentage (eFG%)": "/basketball/ncaa-rankings/?metric=efg",
  "Turnover rate": "/basketball/ncaa-rankings/?metric=tov_rate",
  "Fouls per game": "/basketball/ncaa-rankings/?metric=fpg",
  "Offensive rebounds per game": "/basketball/ncaa-rankings/?metric=orpg",
  "Defensive rebounds per game": "/basketball/ncaa-rankings/?metric=drpg",
  "Minutes per game": "/basketball/ncaa-rankings/?metric=mpg",
  "Turnovers per game": "/basketball/ncaa-rankings/?metric=topg",
  "Steals per game": "/basketball/ncaa-rankings/?metric=spg",
  "Blocks per game": "/basketball/ncaa-rankings/?metric=bpg",
  ...
  "Assist-to-turnover ratio": "/basketball/ncaa-rankings/?metric=ast_to",
  "Three-point and free-throw attempt rates": "/basketball/ncaa-rankings/?metric=three_rate",
  "Possession share": "/basketball/ncaa-rankings/?metric=poss_share",
  "Rim attempt rate": "/basketball/ncaa-shooting/",
  "Transition scoring share": "/basketball/ncaa-shooting/",
  "Unassisted scoring share": "/basketball/ncaa-rankings/?metric=unassisted_share",
...
const recruitingPaths = [
  ...
  ["Verify availability", "/blog/basketball-availability-evidence/", "Read injury, redshirt and tournament-availability signals with the right source, date and evidence boundary."],
];
