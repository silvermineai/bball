    ...
    <>
      <nav className="sport-nav" aria-label="Basketball navigation">
        <div className="sport-nav-primary">
          ...
          <Link href="/basketball/learn/">Learn</Link>
        </div>
        <details className="sport-nav-explore">
          ...
          <div className="sport-nav-panel">
            ...
            <div className="sport-nav-group">
              <div className="eyebrow">Teams &amp; games</div>
            ...
            <div className="sport-nav-group">
              <div className="eyebrow">Recruiting &amp; roster</div>
              <Link href="/basketball/recruiting/fit/">Recruiting fit board</Link>
              <Link href="/basketball/roster-lab/">Roster impact lab</Link>
              <Link href="/basketball/roster-board/">Roster workload board</Link>
              <Link href="/basketball/identity-review/">Identity review queue</Link>
              <Link href="/basketball/crosswalk/">Player ID crosswalk</Link>
            ...
            <div className="sport-nav-group">
              ...
              <Link href="/research/scorecard/?sport=basketball">Forecast record</Link>
              <Link href="/research/markets/?sport=basketball">Market archive</Link>
