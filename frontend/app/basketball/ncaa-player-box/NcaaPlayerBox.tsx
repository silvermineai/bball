...
export default function NcaaPlayerBox() {
  ...
  return <>
    <div className="page-title">
      ...
      <p>Recent game-level NCAA-derived player production with shooting zones, transition splits and playmaking context, plus historical season summaries. Source IDs stay separate from ESPN identities until an audited crosswalk exists. <Link href="/blog/basketball-player-game-logs/">Read the game-log field guide →</Link></p>
    </div>
    <div className="strip">
