...
export default function Page() {
  ...
  return <>
    <div className="page-title">
      ...
      <div className="hero-actions"><Link className="button" href="/basketball/matchups/">Open full matchup slate ↗</Link><Link className="hero-link" href="/research/scorecard/?sport=basketball">Open forecast record →</Link></div>
    </div>
