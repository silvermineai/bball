...
import { completeForecastLabMarketQuotes, forecastLabMarketEvidence, forecastLabQuoteIdentity, hasCompleteForecastLabMarket, latestForecastLabMarketQuote } from "../../_lib/forecast-lab-market";
  ...
  const exportRows = () => downloadCsv(
    ...
    toCsv(
      ...
      rows.map((row) => [
        ...
        row.evidence.market,
        forecastLabMarketEvidence(row.comparisons).state,
        row.signal.estimate,
        row.signal.label,
    ...
    <>
      ...
      <table className="data-table">
          ...
          <tbody>{rows.map((row) => {
            ...
            const marketEvidence = forecastLabMarketEvidence(row.comparisons);
