...
export default function TeamStats() {
  ...
  const exportHeaders = ["Season", "Category", "Field", "Field unit", "Program", "Program ID", "Program archive URL", "Abbreviation", "Displayed value", "Raw numeric value"];
